...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="panel-heading" style=" font-family: Helvetica, Arial, Tahoma, sans-serif; color: blue;"> Tìm thấy: {{count($pro)}} Sản Phẩm</div>
        </section>
        <!-- Main content -->
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div style="float: right;padding-top: 20px; margin-right: 50px;"><a href="{{asset('products/danhsach')}}" class="btn btn-primary">Black</a></div>
